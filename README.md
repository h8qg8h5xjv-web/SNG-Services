...
Готово: **0. Инициализация**, **1. Схема БД**, **2. Интернационализация**, **3. Тестовые данные**, **4. Каталог**, **5. Афиша**, **6. Админка**, **7. Слоты и бронирование**.
Дальше: **8. Участники занятия** (Фаза 2) или **9. Перед запуском** (SEO, метаданные, sitemap).
